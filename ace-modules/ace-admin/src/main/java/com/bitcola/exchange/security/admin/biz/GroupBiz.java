...
import com.bitcola.exchange.security.admin.mapper.GroupMapper;
...
public class GroupBiz extends BaseBiz<GroupMapper, Group> {
    ...
    public void modifyGroupUsers(String groupId, String members, String leaders) {
        ...
        if (!StringUtils.isEmpty(members)) {
            ...
            for (String m : mem) {
                mapper.insertGroupMembersById(groupId, m,UUID.randomUUID().toString());
            }
        }
        if (!StringUtils.isEmpty(leaders)) {
            String[] mem = leaders.split(",");
            for (String m : mem) {
                mapper.insertGroupLeadersById(groupId, m,UUID.randomUUID().toString());
            }
        }
    }
    ...
    public List<AuthorityMenuTree> getAuthorityMenu(String groupId) {
        List<Menu> menus = menuMapper.selectMenuByAuthorityId(groupId, AdminCommonConstant.AUTHORITY_TYPE_GROUP);
