 ...
 * @author zkq
 * 
 * @version 创建时间：2018年9月24日 上午10:10:02
 *
 * 
 */
public class GoogleAuthenticator {
	...
	// 随机盐度
	public static final String SEED = "g8GjEvTbW5oVSV7avL47357538bitcolaLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZx";
	// Java实现随机数算法
	...
	public static String getQRBarcode(String user, String secret) {
		String format = "otpauth://totp/%s?secret=%s&issuer=BITCOLA";
